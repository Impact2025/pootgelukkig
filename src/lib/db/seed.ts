  ...
  const [asielAmsterdam, asielHaarlem, asielZaandam, asielAlkmaar] = await db.insert(asielen).values([
    {
      ...
      beschrijving: 'Het grootste dierenasiel van Amsterdam, opgericht in 1895. Wij vangen jaarlijks ruim 3.000 dieren op en zorgen voor een liefdevolle herplaatsing bij zorgvuldig geselecteerde adoptiegezinnen. Ons team van 45 medewerkers en 120 vrijwilligers staat elke dag klaar voor de dieren in onze zorg.',
      openingstijden: {
        ma: { open: true,  van: '10:00', tot: '17:00' },
        di: { open: true,  van: '10:00', tot: '17:00' },
        wo: { open: true,  van: '10:00', tot: '17:00' },
        do: { open: true,  van: '10:00', tot: '20:00' },
        vr: { open: true,  van: '10:00', tot: '17:00' },
        za: { open: true,  van: '10:00', tot: '16:00' },
        zo: { open: false, van: '11:00', tot: '15:00' },
        notitie: 'Gesloten op nationale feestdagen. Op donderdag tot 20:00 — bezoek op afspraak buiten openingstijden mogelijk.',
      },
      socialMedia: {
        instagram: 'instagram.com/dierenasielamsterdam',
        facebook: 'facebook.com/dierenasielamsterdam',
        tiktok: 'tiktok.com/@dierenasielamsterdam',
        youtube: 'youtube.com/@dierenasielamsterdam',
      },
      asielConfig: {
        spoedTelefoon: '06-12345678',
        kvkNummer: '41202565',
        anbiStatus: true,
        iban: 'NL47 RABO 0117 6276 33',
        maxCapaciteit: 120,
        specialisaties: ['honden', 'katten', 'konijnen', 'knaagdieren', 'vogels'],
        notificaties: {
          emailBijAanvraag: true,
          emailBijBericht: true,
          dagelijkseDigest: true,
        },
        adoptieProcedure: {
          minimumLeeftijdAdoptant: 18,
          tuinVereist: false,
          huisbezoekVereist: true,
          wachttijdDagen: 7,
          vereisten: 'Adoptanten moeten minimaal 2 uur per dag thuis zijn voor honden. Bij gezinnen met kinderen jonger dan 5 jaar adviseren wij katten van 2 jaar of ouder. Wij doen altijd een thuischeck vóór de definitieve adoptie. Huurders hebben toestemming van de verhuurder nodig.',
        },
      },
    },
    {
